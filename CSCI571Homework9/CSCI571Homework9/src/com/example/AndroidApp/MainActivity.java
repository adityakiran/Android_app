		    ...
		    public void onClick(View v) {
		       // startActivity(new Intent(MainActivity.this,ResultActivity.class));
		    	 ...
		    	 if (streetString.length()==0) {
		    		 ...
		    		 valid_1.setText("Required field");
		    		 noError=false;
					}
		    	 valid_2.setVisibility(View.INVISIBLE);
		    	 ...
		    	 if (cityString.length()==0) {
		    		 ...
		    		 valid_2.setText("Required field");
		    		 noError=false;
					}
		    	 valid_3.setVisibility(View.INVISIBLE);
		    	  String stateString = (String)state.getSelectedItem();
		    	 if (stateString.length()==0l) {
		    		 valid_3.setVisibility(View.VISIBLE);
		    		 valid_3.setText("Required field");
		    		 noError=false;
					}
		    	...
		    	String url="";
		    	 if(noError)
		    	 {
					...
					try {
						...
						//url = "http://rajhw7-env.elasticbeanstalk.com/?stateInput="+query1+"&cityInput="+query2+"&stateInput=CA";
						url="http://rajhw7-env.elasticbeanstalk.com/?streetInput="+query1+"&cityInput="+query2+"&stateInput="+query3;
